...
## RESULT:
The host took 0.843094 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.845182 seconds. Inter takes less time to execute than Float. Therefore, Int variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
