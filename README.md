...
<h3>ENTER YOUR REGISTER NO 212224230150</h3>
<h3>EX. NO 02 </h3>
...
## OUTPUT:
### FLOAT:
<img width="542" height="129" alt="image" src="https://github.com/user-attachments/assets/f6a51ac7-ff51-4311-98a9-9acae4b62b4c" />

### INT:

<img width="573" height="111" alt="image" src="https://github.com/user-attachments/assets/7791ed87-36a4-4893-ac8f-6954a66e785c" />


## RESULT:
The host took 0.843094 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.845182 seconds. Integer takes less time to execute than Float. Therefore, Int variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
